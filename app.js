...
const sessionStore = new MongoDBStore({
  uri: 'mongodb+srv://ashwin:ashwinashwin@cluster0.ddhln6v.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0',
...
app.post('/verifyLogin', async function (req, res) {
  ...
  const passwordAreEqual = await bcryptjs.compare(password, "$2a$10$ptGrmGXQQKQlEwwvwY3fO.Q5IOo1b9nYEyrLuT/Gq2QUvXQHANkJ6");
